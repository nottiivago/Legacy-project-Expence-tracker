...
//   };
  ...
  return (
    <div className="min-h-screen px-3 bg-cover bg-center bg-no-repeat pt-5 " 
    style={{
      backgroundImage: "url('/assets/Back.webp')",
    }}
  >
      
      <div className="mt-5 mx-auto  border-2 border-black rounded-md max-w-[350px] sm:max-w-[500px]">
      ...
      <div className="px-3 mt-5 h-[80px] w-[80px] mx-auto bg-cover border-black border-2 rounded-full" 
    style={{
      backgroundImage: "url('/assets/Logo1.webp')",
    }}
  >
